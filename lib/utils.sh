...
declare -x LOG_OUTPUT=${LOG_OUTPUT:-"/tmp/denv.log"}
OS_PLATFORM=`uname -s`
    ...
    if [ $FNRET = 1 ]; then
        if command -v brew >/dev/null 2>&1; then
            ...
            then
                ...
                brew_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                yum_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                apt_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                pacman_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                port_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                choco_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                dnf_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                emerge_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
            ...
            then
                ...
                zypper_install $PACKAGE > $LOG_OUTPUT 2>&1
            fi
        else
...
upgrade_package()
{
    ...
    if command -v brew >/dev/null 2>&1; then
        ...
        then
            ...
            brew_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v yum >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            yum_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v apt-get >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            apt_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v pacman >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            pacman_upgrade$PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v port >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            port_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v choco >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            choco_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v dnf >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            dnf_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v emerge >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            emerge_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v zypper >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            zypper_upgrade $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    else
        crit "Not found software installer."
        FNRET=1
...
remove_package()
{
    ...
    if command -v brew >/dev/null 2>&1; then
        ...
        then
            ...
            brew_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v yum >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            yum_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v apt-get >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            apt_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v pacman >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            pacman_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v port >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            port_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v choco >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            choco_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v dnf >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            dnf_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v emerge >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            emerge_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    elif command -v zypper >/dev/null 2>&1; then
        if [ $VERBOSE -eq 1 ]
        then
            ...
            zypper_uninstall $PACKAGE > $LOG_OUTPUT 2>&1
        fi
    else
        crit "Not found software installer."
        FNRET=1
...
npm_uninstall()
{
    ...
    if [ $FNRET = 1 ]; then
        ...
        then
            ...
            $SUDO_CMD npm uninstall $PACKAGE -y > $LOG_OUTPUT 2>&1
        fi
        if [ $? = 0 ]; then
            FNRET=0
        else
...
npm_update()
{
    ...
    if [ $FNRET = 1 ]; then
        ...
        then
            ...
            $SUDO_CMD npm update $PACKAGE > $LOG_OUTPUT 2>&1
        fi
        if [ $? = 0 ]; then
            FNRET=0
        else
...
pip_install()
{
    ...
    if [ $FNRET = 1 ]; then
        ...
        then
            ...
            $SUDO_CMD pip install -i https://mirrors.aliyun.com/pypi/simple/ $PACKAGE > $LOG_OUTPUT 2>&1
        fi
        if [ $? = 0 ]; then
            FNRET=0
        else
...
pip_uninstall()
{
    ...
    if [ $FNRET = 1 ]; then
        ...
        if [ $VERBOSE -eq 1 ]
        then
            $SUDO_CMD pip uninstall $PACKAGE -y > $LOG_OUTPUT
        else
            $SUDO_CMD pip uninstall $PACKAGE -y > $LOG_OUTPUT 2>&1
        fi
        if [ $? = 0 ]; then
            FNRET=0
        else
